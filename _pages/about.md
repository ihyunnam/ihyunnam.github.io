---
permalink: /
seo_title: "Ihyun Nam — CS PhD"
description: "I'm a first year Computer Science Ph.D. student at Stanford University, co-advised by Professors David Mazières and Emma Dauterman. My research interests are in applied cryptography and systems security."
author_profile: true
redirect_from:
  - /about/
  - /about.html
...
<p class="entry-title"><b>Synchronous Key Rotations in Federated Systems</b></p>
<p class="entry-lines">Stanford Security Lunch <em>Lightning Talk</em> (Stanford, CA): May 2026</p>

<p class="entry-title"><b>Passlog: Authentication Logging with Public State</b></p>
<p class="entry-lines">Stanford Security Lunch (Stanford, CA): April 2026<br>Stanford Computer Forum (Stanford, CA): April 2026<br>(Upcoming) The Science of Blockchain Conference (Stanford, CA): July 2026<br>(Upcoming) Stanford Input-Output Research Hub Mini-Conference (Stanford, CA): July 2026</p>

<p class="entry-title"><b>The Avg-Act Swap and Plaintext Overflow Detection in Homomorphic Operations Over Deep Circuits</b></p>
<p class="entry-lines">CODASPY (Porto, Portugal): June 2024<br>Symposia for Undergraduate Research and Public Service (Stanford, CA): October 2023</p>

<p class="entry-title"><b>Shuffle Squares and Reverse Shuffle Squares</b></p>
<p class="entry-lines">Symposia for Undergraduate Research and Public Service (Stanford, CA): October 2022</p>
